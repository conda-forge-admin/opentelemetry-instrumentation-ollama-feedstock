About opentelemetry-instrumentation-ollama-feedstock
====================================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/opentelemetry-instrumentation-ollama-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/opentelemetry-instrumentation-ollama-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add opentelemetry-instrumentation-ollama
# for installing globally
pixi global install opentelemetry-instrumentation-ollama
```
...
It is possible to list all of the versions of `opentelemetry-instrumentation-ollama` available on your platform:
...
```
pixi search opentelemetry-instrumentation-ollama --channel conda-forge
```
